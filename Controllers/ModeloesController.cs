...
namespace MVC2._0.Controllers
{
    public class ModeloesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_modelo,MODELO1,CODIGO")] Modelo modelo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_modelo,MODELO1,CODIGO")] Modelo modelo)
        {
            if (ModelState.IsValid)
            {
